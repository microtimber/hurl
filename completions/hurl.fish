...
complete -c hurl -l keep-binary-body -d 'Keep binary response body'
...
complete -c hurl -l truncate-text-body -d 'Truncate text body to BYTES bytes, -1 for full body'
