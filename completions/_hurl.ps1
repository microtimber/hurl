    ...
    $completions = @(switch ($command) {
        'hurl'
         {[CompletionResult]::new('--aws-sigv4', 'aws-sigv4', [CompletionResultType]::ParameterName, 'Use AWS V4 signature authentication in the transfer')
            ...
            [CompletionResult]::new('--keep-binary-body', 'keep-binary-body', [CompletionResultType]::ParameterName, 'Keep binary response body')
            ...
            [CompletionResult]::new('--truncate-text-body', 'truncate-text-body', [CompletionResultType]::ParameterName, 'Truncate text body to BYTES bytes, -1 for full body')
