...
pub const HURL_TRUNCATE_BODY: &str = "HURL_TRUNCATE_BODY";
...
impl RunContext {
    ...
    /// Returns the env var for truncating request and response bodies.
    pub fn truncate_body_env_var(&self) -> Option<&str> {
        self.hurl_env_vars
            .get(HURL_TRUNCATE_BODY)
            .map(|v| v.as_str())
    }
